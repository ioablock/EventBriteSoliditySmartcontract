...
struct CreateEvent {
    bytes32 eventId;
    //IPFS hash containing information like the event name and description
    string eventDataCID;
    address eventOwner;
...
// function that will get called when a user creates a new event in our frontend
function createNewEvent(
    ...
    idToEvent[eventId] = CreateEvent(
        ...
        confirmedRSVPs,
        claimedRSVPs,
        //boolean paidOut to false because at the time of eventCreation, there have been no payouts to the RSVPers (there are none yet) or the event owner yet
        false
    );
...
//function that will withdraw deposits of people who didn’t show up to the event 
//and send them to the event organizer
